...
define(["N/email", "N/https", "N/record", "N/log", "N/runtime", "N/search"], (
  ...
  const getPurchaseOrders = () => {
    var purchaseOrderNumber = runtime.getCurrentScript().getParameter({
      name: "custscriptpurchaseordernumber",
    });

    log.debug("Purchase Order Number param", purchaseOrderNumber);
    const params = `$filter=statusId%20ne%20%27NEW%27%20and%20statusId%20ne%20%27API%20LOCK%27%20and%20statusId%20ne%20%27CANCELED%27%20and%20statusId%20ne%20%27ORDERED%27%20and%20purchaseOrderNumber%20eq%20%27${purchaseOrderNumber}%27`;
