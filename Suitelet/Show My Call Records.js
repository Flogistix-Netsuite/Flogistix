...
define(['N/ui/serverWidget', 'N/task', 'N/runtime', 'N/search', 'N/redirect','N/https','N/url','N/task'],
    ...
    function onRequest(context) 
    {
        ...
        if (request.method == 'GET') 
        {
        	...
        	var invoices=[];
        	var customers=[];
        	var form=widget.createForm({title:'Statements!'});			
        	var sList=form.addSublist({id:'customers',type:'inlineeditor',label:'Send these Statments'});
			...
			*/
			...
			form.addSubmitButton({label:'Send Statements!'})
